...
def Create_features(input_wav,begin=None,end=None,Atal=False):
    ...
    if Atal:
        feature_file = output_directory+"ATAL_features_"+input_wav.replace('.wav','.txt')
    else:
        feature_file = output_directory+"features_"+input_wav.replace('.wav','.txt')
    if begin is not None and end is not None:
